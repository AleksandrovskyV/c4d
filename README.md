...
> "Deformer Strength" slider in 2D Convert mode between 0 and 100 has a slight precision error (currently working on a fix). However, it works fine at exact values of 0 and 100 <br>
